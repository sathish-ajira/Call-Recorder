...
public class SelectedContactsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        AppConstant.activityName = "Selected";
    ...
    public void refreshRealmInstance(){
        ...
        setRealmAdapter(RealmController.with(this).getSavedContactRecords("Selected"));
        int size = (RealmController.with(this).getSavedContactRecords("Selected")).size();
    }
        ...
        switch (reqCode) {
            case (PICK_CONTACT):
                if (resultCode == Activity.RESULT_OK) {
                    ...
                    phone = managedQuery(contactData,
                            null, null, null, null);
