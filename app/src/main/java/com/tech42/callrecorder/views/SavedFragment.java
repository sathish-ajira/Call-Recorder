...
public class SavedFragment extends Fragment {
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        editor.putString("Activity","Cloud");
        editor.commit();
        setupRecyclerView();
        getRealmInstance();
        setupRecyclerView();
    ...
    public void refreshRealmInstance(){
        ...
        if (list.size() == 0){
            setRealmAdapter(RealmController.with(this).queryedCallRecords("storage", "Cloud"));
            size = (RealmController.with(this).queryedCallRecords("storage", "Cloud").size());
            if (size == 0){
            ...
            if (list.size() == 2){
                callRecords = RealmController.with(this).queryedCallRecords(list.get(0), list.get(1), "storage", "Cloud");
                size = callRecords.size();
            } else if (list.size() == 4){
                callRecords = RealmController.with(this).queryedCallRecords(list.get(0), list.get(1), list.get(2), list.get(3), "storage", "Cloud");
                size = callRecords.size();
            } else if (list.size() == 6){
                callRecords = RealmController.with(this).queryedCallRecords(list.get(0), list.get(1), list.get(2), list.get(3),
                        list.get(4), list.get(5), "storage", "Cloud");
                size = callRecords.size();
            } else if (list.size() == 8){
                callRecords = RealmController.with(this).queryedCallRecords(list.get(0), list.get(1), list.get(2), list.get(3),
                        list.get(4), list.get(5),list.get(6), list.get(7), "storage", "Cloud");
                size = callRecords.size();
            } else if (list.size() == 10){
                callRecords = RealmController.with(this).queryedCallRecords(list.get(0), list.get(1), list.get(2), list.get(3),
                        list.get(4), list.get(5),list.get(6), list.get(7),list.get(8), list.get(9), "storage", "Cloud");
                size = callRecords.size();
            } else if (list.size() == 12){
                callRecords = RealmController.with(this).queryedCallRecords(list.get(0), list.get(1), list.get(2), list.get(3),
                        list.get(4), list.get(5),list.get(6), list.get(7),list.get(8), list.get(9), list.get(10), list.get(11), "storage", "Cloud");
                size = callRecords.size();
            }
